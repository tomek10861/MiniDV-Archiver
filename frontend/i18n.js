...
(function () {
  const EN = {
    ...
    'dup.keepBestAll': '✓ Keep best in every group', 'dup.confirmKeepAll': 'Keep the best scene in each of {g} groups and delete {n} duplicates total?',
  ...
  const PL = {
    ...
    'view.list': 'Lista', 'view.grid': 'Kafelki',
    'scene.n': 'Scena {n}',
    'scene.frames': '{n} kl.',
    ...
    'dup.keepBestAll': '✓ Zostaw najlepsze we wszystkich grupach', 'dup.confirmKeepAll': 'Zostawić najlepszą scenę w każdej z {g} grup i usunąć łącznie {n} duplikatów?',
